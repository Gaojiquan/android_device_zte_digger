...
{
    static char* headers[] = {  "从SD卡上的zip包应用更新",
                                "",
                                NULL
    };
    
    char* install_menu_items[] = {  "从外置SD卡上选择zip包",
                                    "应用/sdcard/update.zip",
                                    "打开/关闭签名验证",
                                    NULL,
                                    NULL };

    char *other_sd = NULL;
    if (volume_for_path("/sdcard2") != NULL) {
        other_sd = "/sdcard2/";
        install_menu_items[3] = "从内置SD卡上选择ZIP包";
    }
    else if (volume_for_path("/external_sd") != NULL) {
        other_sd = "/external_sd/";
        install_menu_items[3] = "从外置卡上选择ZIP包";
    }
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            ...
            {
                if (confirm_selection("确定要安装吗?", "是 - 安装 /sdcard/update.zip"))
...
void show_choose_zip_menu(const char *mount_point)
{
    ...
    static char* headers[] = {  "选定一个ZIP包以升级",
                                "",
                                NULL
    };
    ...
    if (file == NULL)
        return;
    static char* confirm_install  = "确定要安装吗?";
...
void show_nandroid_restore_menu(const char* path)
{
    ...
    static char* headers[] = {  "选择一个用来恢复的镜像",
                                "",
                                NULL
    };
    ...
    if (confirm_selection("确定要恢复?", "是 - 恢复"))
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            case 0:
                ...
                if (confirm_selection( "确定擦除?", "是 - 擦除Dalvik缓存")) {
                    __system("rm -r /data/dalvik-cache");
                    __system("rm -r /cache/dalvik-cache");
                    __system("rm -r /sd-ext/dalvik-cache");
                    ui_print("Dalvik缓存擦除成功.\n");
                }
