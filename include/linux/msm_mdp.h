...
#define MSMFB_BUFFER_SYNC _IOW(MSMFB_IOCTL_MAGIC, 162, struct mdp_buf_sync)//focus.lau added for libhwcomposer
#define MSMFB_OVERLAY_COMMIT _IOW(MSMFB_IOCTL_MAGIC, 163, unsigned int)//focus.lau added for libexternal
#define MSMFB_DISPLAY_COMMIT  _IOW(MSMFB_IOCTL_MAGIC, 164, struct mdp_display_commit)//focus.lau added for libgralloc
...
struct msmfb_overlay_data {
 ...
 struct msmfb_data dst_data;//focus.lau added
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
